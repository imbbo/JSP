...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <%
    	/*
    	- 세션에 저장한 데이터는 브라우저 창이 종료될 떄 까지, 혹은
    	...
    	*/
    	...
    	//  getAttribute의 리턴타입은 Object이기 떄문에
    	// 강제 형변환을 통해 차입을 내려서 준비한 변수에 대입해야 합니다.
    	...
    	// 해당 페이지에서는 더 이 상 세션 객체를 사용할 수 없기 때문에
    	// 아래의 코드는 에러가 발생합니다.
    	// 새롭게 요청이 들어오기 전 까지는 세션 객체를 사용할 수 없습니다.
    	hobbies = (String[]) session.getAttribute("hobbies");
    	out.print("삭제 후 hobies의 값: " + Arrays.toString(hobbies));
